...
function contactInfo(array, callback) {
  callback(array["first_name"]);
}
function newContactInfo(array, cb) {
  cb(array["email"]);
}
contactInfo(graduates, (firstName) => {
  console.log(firstName)
})
newContactInfo(graduates, (Email) => {
  console.log(Email)
})
...
console.log("This is all of the universities with Uni included in thier name: " + JSON.stringify(uni));
...
*/
const animalNames = (list, callBack) => {
  for(let i = 0; i < list.length; i++) {
    callBack(list[i], i);
  }
};
animalNames(zooAnimals, function(animal_name, scientific_name) {
  console.log("this is both names", animal_name, scientific_name);
});
